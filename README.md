...
- ![](http://ws3.sinaimg.cn/large/6d4090c8gy1fu858xbdvyj200o00o06y.jpg)点击翻页：可通过点击屏幕来翻页。（翻页默认通过鼠标滚轮上下滚动翻页，但因为是滚动一次翻一页，所以在平板或笔记本上不用鼠标很难精确地只翻一页，于是就有了这个功能。另外也能通过上下滑动、方向键、空格来翻页）
