...
const abreastShowColumn = createThrottleMemo(() => {
  if (abreastArea().columns.length === 0) return {
    start: 0,
    end: 0
  };
...
var _tmpl$$A = /*#__PURE__*/web.template(\`<div><div tabindex=-1>\`);
const ComicImgFlow = () => {
  const {
    hiddenMouse,
    onMouseMove
