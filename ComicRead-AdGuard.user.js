...
const handleVersionUpdate = async () => {
  ...
  if (helper.lang() === 'zh') {
    Toast.toast(() => /* eslint-disable i18next/no-literal-string */[(() => {
      ...
      return _el$;
    })(), web.template(\`<h3>新增\`)(), web.template(\`<ul><li>增加 ehentai 标签检查功能\`)(), web.template(\`<h3>修复\`)(), web.template(\`<ul><li><p>修复 ehentai 上与其他脚本冲突导致的显示异常 </p></li><li><p>修复拷贝漫画高清画质替换失效的 bug\`)(), web.createComponent(VersionTip, {
      v1: version,
      v2: '10.8.0',
      get children() {
