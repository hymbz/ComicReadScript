...
const ErrorSvg = (index: number) => {
  ...
  return (
    <Show when={store.imgList[index]?.loadType === 'error'}>
      <svg
...
export const ErrorTip = () => <For each={activePage()} children={ErrorSvg} />;
