...
迁移至 @panzoom/panzoom 的代码已经完成大半，但因为目前 4.5.1 版本有 bug，无法在 shadow dom 下使用，虽然已经合并了相关 pr 但还没打包新版本，需要等待之后新版更新。
TODO: https://github.com/timmywil/panzoom/issues/536
