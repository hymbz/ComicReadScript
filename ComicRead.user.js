...
var _tmpl$$1 = /*#__PURE__*/web.template(\`<h2>🥳 ComicRead 已更新到 v\`),
  ...
  _tmpl$3 = /*#__PURE__*/web.template(\`<ul><li><p>在卷轴模式下使用鼠标拖拽滚动页面 </p></li><li><p>支持 Anchira\`);
