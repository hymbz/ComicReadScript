...
const _tmpl$$1 = /*#__PURE__*/web.template(\`<h2>🥳 ComicRead 已更新到 v\`),
  ...
  _tmpl$3 = /*#__PURE__*/web.template(\`<ul><li>修复手机上卷轴模式的显示异常\`),
  _tmpl$4 = /*#__PURE__*/web.template(\`<h3>优化\`),
  _tmpl$5 = /*#__PURE__*/web.template(\`<ul><li>增加切换图片自动放大选项的快捷键\`);
