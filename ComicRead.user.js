...
() => {
  ...
  let popper;
  const Popper = () => {
    popper ||= [web.createComponent(SettingPanel, {}), (() => {
...
const handleVersionUpdate = async () => {
  ...
  if (helper.lang() === 'zh') {
    Toast.toast(() => /* eslint-disable i18next/no-literal-string */[(() => {
      ...
      return _el$;
    })(), web.template(\`<h3>修复\`)(), web.template(\`<ul><li>修复在部分网站上无法正常运行的 bug\`)(), web.createComponent(solidJs.Show, {
      get when() {
