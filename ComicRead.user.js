...
const handleVersionUpdate = async () => {
  ...
  if (helper.lang() === 'zh') {
    toast(() => /* eslint-disable i18next/no-literal-string */[(() => {
      ...
      return _el$;
    })(), web.template(\`<h3>修复\`)(), web.template(\`<ul><li><p>修复部分网站下载漫画图片的扩展名错误 </p></li><li><p>修复简易阅读模式在部分网站上未正常运行\`)(), web.createComponent(VersionTip, {
      v1: version,
      v2: '9.5.0',
      get children() {
